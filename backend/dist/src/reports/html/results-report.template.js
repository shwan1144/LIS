...
function formatRange(ot, patientSex) {
    const test = ot.test;
    if (!test)
        return '-';
...
function buildResultsReportHtml(input) {
    ...
    const commentsText = input.comments.length ? input.comments.join(' â€¢ ') : '';
...
<head>
  ...
  <style>
    ...
    body { margin: 0; font-family: 'Segoe UI', Arial, sans-serif; font-size: 12px; color: #333; position: relative; }

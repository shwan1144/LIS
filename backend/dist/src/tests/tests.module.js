...
exports.TestsModule = TestsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([test_entity_1.Test, pricing_entity_1.Pricing, test_component_entity_1.TestComponent, order_test_entity_1.OrderTest])],

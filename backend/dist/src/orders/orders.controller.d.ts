...
export declare class OrdersController {
    ...
    findHistory(req: RequestWithUser, page?: string, size?: string, search?: string, status?: string, patientId?: string, startDate?: string, endDate?: string, resultStatus?: OrderResultStatus): Promise<{

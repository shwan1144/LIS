...
export enum AuditAction {
  ...
  PLATFORM_TEST_TRANSFER = 'PLATFORM_TEST_TRANSFER',
  ...
  PLATFORM_BULK_MESSAGE_CONFIG_UPDATE = 'PLATFORM_BULK_MESSAGE_CONFIG_UPDATE',
  PLATFORM_BULK_MESSAGE_SEND = 'PLATFORM_BULK_MESSAGE_SEND',
  PLATFORM_BULK_MESSAGE_JOB_UPDATE = 'PLATFORM_BULK_MESSAGE_JOB_UPDATE',
}
